...
export const RegisterForm = () => {
    ...
    const {user, registerStart} = useUserStore()
                            ...
                            <div className="divide-y divide-gray-200">
                                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    ...
                                    <input 
                                        ...
                                        <label type="name" className="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Name</label>
                                    </div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <label type="last_name" className="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Last Name</label>
                                    </div>
                                    ...
                                    <div className="relative">
                                        <button 
                                            className="bg-emerald-600 text-white rounded-md px-2 py-1 hover:bg-green-900">
                                                Register
                                        </button>
